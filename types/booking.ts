...
export interface Booking { id: string; instrument_id: string; user_id: string; start_time: string; end_time: string; sample_name: string; purpose: string; notes: string | null; status: BookingStatus; cancelled_at: string | null; cancelled_by: string | null; cancellation_reason: string | null; created_at: string; updated_at: string; }
